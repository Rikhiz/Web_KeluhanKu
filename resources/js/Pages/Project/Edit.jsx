...
export default function Edit({ auth,project }) {
  ...
  <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
      <form encType="multipart/form-data" onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg" >
        <div>
          {
            project.image_path && (
              <div className="mb-4">
        ...
        <div className="flex justify-between items-center">
                ...
                className="bg-emerald-100 py-1 px-3 text-gray-800 rounded shadow transition-all hover:bg-gray-200 mr-2">
                Cancel
                </Link>
