...
export default function Index({ auth, projects, queryParams = null ,success}) {
    ...
    const deleteProject = (project)=>{
        if(!window.confirm("are You Sure want to deletet this project")){
            return ;
        }
                                ...
                                <tbody>
                                    {projects.data.map((project) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-3 py-2 text-nowarp hover:underline">
                                            ...
                                            <td className="px-3 py-2 text-right">
                                               ...
                                               <button onClick={(e) => deleteProject(project)} className="font-medium text-blue-600 dark:text-red-500 hover:underline mx-1">
                                                Delete
                                               </button>
                                            </td>
                                        </tr>
